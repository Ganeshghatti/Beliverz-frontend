    ...
    >
      ...
      <div className="flex md:flex-col-reverse justify-between md:gap-4">
        <div className="flex flex-col gap-3 justify-center w-1/2 md:w-full">
          ...
          <p className="text-black3 text-2xl md:text-xl">
            ...
            learners, in collaboration, we uplift. For knowledge is not static,
            confined to a bookshelf, But a living, breathing entity, shaped by
            collective self.
          </p>
        </div>{" "}
        <img
      ...
      <div className="flex md:flex-col justify-between md:gap-4">
        ...
        <div className="flex flex-col gap-3 justify-center w-1/2 md:w-full">
          ...
          <p className="text-black3 text-2xl md:text-xl">
            Embarking on JRF preparation revealed a gap in dedicated platforms.
            Recognizing the need, we've crafted a precise and insightful
            companion for JRF aspirants, offering tailored resources, guidance,
      ...
      <div className="flex md:flex-col-reverse justify-between md:gap-4">
        <div className="flex flex-col gap-3 justify-center w-1/2 md:w-full">
          ...
          <p className="text-black3 text-2xl md:text-xl">
            ...
            innovation, and holistic development. By highlighting the essence of
            the journey—nurturing a passion for research and knowledge—we hope
            to be catalysts for academic success.
          </p>
        </div>{" "}
        <img
      ...
      <div className="flex md:flex-col justify-between md:gap-4">
        ...
        <div className="flex flex-col gap-3 justify-center w-1/2 md:w-full">
          ...
          <p className="text-black3 text-2xl md:text-xl">
            Pursuing our inclusive vision, we cultivate a dynamic JRF community,
            promoting shared knowledge and continuous learning. Our platform is
            a virtual sanctuary, transforming aspirations into a journey of
            success and fostering intellectual growth beyond exams.
          </p>
        </div>
      </div>
    </section>
